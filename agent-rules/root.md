...
- **Gaps become tickets, not edits.** An audit agent does not silently fix gaps. It files a ticket (in tickets/ for tess) following the aspect's optional `ticket-template`, if a ticket doesn't already exist.
